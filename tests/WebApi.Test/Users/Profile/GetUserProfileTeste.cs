...
{
    public class GetUserProfileTeste : CashFlowClassFixture
    {
        ...
        public GetUserProfileTeste(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
        {
